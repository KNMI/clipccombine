...
def visualise1( fig , url_combo ):

	#fig = plt.figure(1)

	print "ANDREJ ", url_combo

	visualiseUrl( fig , url_combo,'111')
...
# 	visualiseUrl( fig , url_1,'131')

# 	visualiseUrl( fig , url_2,'132')

# 	visualiseUrl( fig , url_combo,'133')
