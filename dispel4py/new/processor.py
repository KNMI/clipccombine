...
def process_and_return(graph, inputs, target, remaining):
    
    from importlib import import_module
    
    #print "Arguments: "+str(args)+" rem: "+str(remaining)
    ...
    try:
        ...
        args = parse_args(remaining, None)
    except SystemExit:
...
def main():   # pragma: no cover
    ...
    process_and_return(graph, inputs, args.target, remaining)
